...
// ### 在这里硬编码您的域名！ ###
const YOUR_DOMAIN_TO_APPEND = '@student.pmrb.edu.pl';
...
const loginService = {
	...
	async login(c, params) {
		...
		if (!await cryptoUtils.verifyPassword(password, userRow.salt, userRow.password)) throw new BizError(t('IncorrectPwd'));
